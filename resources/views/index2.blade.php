...
<body>
  ...
  -->
        ...
        <div class="wrapper">
         ...
         <button class="header-top-btn" @if(session('UserId'))onclick="location.href='AddHome'" @else onclick="LoginAlert()" @endif>Create Profile </button>
        </div>
        ...
        <nav class="navbar" data-navbar>
          ...
          <div class="navbar-bottom">
            <ul class="navbar-list">
              ...
              <li>
                <a href="BuyPage" class="navbar-link" data-nav-link>Jobs</a>
               </li>
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="hero-subtitle">
              ...
              <span>Job Finder Website</span>
            </p>

            <h2 class="h1 hero-title">Find Jobs with us</h2>
          ...
          <figure class="hero-banner">
            <img src="./assets/images/Office.webp" alt="Modern house model" class="w-100">
          </figure>
