...
<section class="filterb">
    <div class="filter" >
        <h5 class="label"> Results</h5>

        <p class="pfilter"> results</p>
      ...
      <section class="property" id="property">
        <div class="container">
          <p class="section-subtitle">Meetings</p>
          <h2 class="h2 section-title">Meetings</h2>
...
<div class="property-card" >
  ...
  <figure class="card-banner">
    ...
    <a href="ViewProperty/">
      <img src="" alt="Comfortable Apartment" class="w-100">
    </a>
  ...
  <div class="card-content">
    ...
    <p class="card-text">
                        ...
                        <form action="DeleteProperty/" method="post" id="PropertyDelete">
                            @csrf
  ...
  <div class="card-footer">
    ...
    <div class="card-author">
      ...
      <figure class="author-avatar">
        <img src="ProfileImages" alt="William Seklo" class="w-100">
      </figure>
