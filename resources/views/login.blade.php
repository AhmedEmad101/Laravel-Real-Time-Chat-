...
<body>
    <div class="hero">
      <div class="form-box">
        ...
        <form id="login" class="input-g" method="POST" action="Auth" >
            @csrf

        <input type="email" class="input-f" placeholder=" Email " name="email" maxlength="30" id="email" required >
        <input type="password" class="input-f" placeholder="Password" name="password" maxlength="20" id="password" required >
        ...
        <form id="register" class="input-g" method="POST" action="">
            @csrf
